<template>
	<footer class="background--black">
			...
			<div class="row">
				<div class="column small-full medium-third">
					...
					>
						<g fill="white">
							<path
								d="M109.237,237.564c2.501-0.722,7.519,8.487,8.889,10.15c3.409,4.137,7.474,7.939,12.599,9.793
		...
		C110.39,237.231,108.181,237.859,109.237,237.564z"
							></path>
							<path
								d="M185.385,180.977c7.937-0.376,13.078,25.715,14.691,31.135c4.683,15.742,9.144,31.565,15.262,46.829
		...
		C176.118,209.996,176.488,181.4,185.385,180.977C188.006,180.853,182.803,181.099,185.385,180.977z"
							></path>
							<path
								d="M173.858,165.957c-10.133-0.995-9.696-32.465-9.761-37.873c-0.217-18.078,1.548-36.56-0.941-54.532
		...
		C186.422,132.982,179.866,166.564,173.858,165.957C172.537,165.827,175.125,166.085,173.858,165.957z"
							></path>
							<path
								d="M231.493,253.282c-10.652,6.932-21.7-39.219-22.538-44.174c-3.516-20.786-4.675-41.989-2.64-62.99
				...
				<div class="column small-full medium-third">
					<div class="content">
						<div>
							...
							<ul>
								<li>
									<a href="https://www.silicons.nl">
										Silicons
									</a>
								</li>
								<li>
									<a href="https://passport.svd.im">
										Passport
									</a>
								</li>
								<li>
									<a href="https://cheatsheet.svd.im">
										Cheatsheet
									</a>
								</li>
								<li>
									<a href="https://dragndrop.svd.im">
										Vue DragNdrop
									</a>
								</li>
								<li>
									<a href="https://css-order.svd.im">
										CSS Order
									</a>
								</li>
								<li>
									<a href="https://grid-tool.svd.im">
										Grid Tool
									</a>
								</li>
								<li>
									<a href="https://overlay.svd.im">
										Overlay
									</a>
								</li>
								<li>
									<a href="https://datepicker.svd.im">
										Date Picker
									</a>
								</li>
							</ul>
				...
				<div class="column small-full medium-third">
					<div class="content">
						<div>
							...
							<ul>
								<li>
									<a href="https://www.npmjs.com/package/@sil/grid">
										Vue Grid
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/paroller">
										Vue Paroller
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/ratio">
										Vue Ratio
									</a>
								</li>
								<li>
									<a href="https://npmjs.com/sildcss-order.svd.im">
										Vue Pointer
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/reload">
										Vue Reload
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/scroll-parallax">
										Vue Scroll Parallax
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/scroll-progress">
										Vue Scroll Progress
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/scrollto">
										Vue ScrollTo
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/scroll-trigger">
										Vue ScrollTrigger
									</a>
								</li>
								<li>
									<a href="https://www.npmjs.com/package/@sil/zoom-image">
										Vue Simple Image Zoom
									</a>
								</li>
							</ul>
						</div>
